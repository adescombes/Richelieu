...
- gallica_json_to_text : pour l'instant utilise un fichier JSON (donc un annuaire), en prend les 30 premières pages (+ métadonnées) pour constituer un échantillon à tester pour cleaning

- DOSSIER test ocr annuaire : voir README de ce dossier. Différents tests d'OCR et de nettoyage de texte